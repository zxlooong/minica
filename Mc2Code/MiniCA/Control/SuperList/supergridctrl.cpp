...
/*
	...
	4 dec. 1998.
				...
				- Added some examples on how to print preview selected item(or at least to get some information from of the grid)
				  the sample is in the CTreeList.h/cpp which is derived from CSuperGridCtrl it shows you
   ...
   22.june 1999 - Added GetCount()
				...
				- added GetTreeItem(.....) 
				- GetSelectedItem(.....)
				- Howto disable Drag/drop in CTreeList
				- level 4 compiled
	...
	9. juli 99  - CRAIG SCHMIDT "the beachboy":)
				  ...
				  see the file CTreeList.cpp for usage of the InsertRootItem.
	...
	14. juli 99	 - Fixed a memory leak in CTreeList::HowToInsertItemsAfterTheGridHasBeenInitialized....
