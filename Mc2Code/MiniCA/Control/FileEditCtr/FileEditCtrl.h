...
public:
// User functions
	void SetFilter(CString strFilter)			//hpxs , 设置对话框过滤器
	{
		m_strFilter = strFilter;
	}
	void SetCaption(CString strCaption)			//hpxs , 设置对话框Caption
	{
		m_szCaption = strCaption;
	}
...
// member variables
private:
	CString			 m_strFilter;			//hpxs 对话框过虑器,默认为所有文件
