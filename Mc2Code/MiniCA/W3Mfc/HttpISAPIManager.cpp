...
CIniHttpISAPIManager::CIniHttpISAPIManager()
{
}
...
void CIniHttpISAPIManager::FullArraysFromMultiSZString(LPTSTR pszString)
{
...
int CIniHttpISAPIManager::Initialize(const CString& sIniPath, const CString& sSection)
{
  DWORD dwSize = 1024;
  BOOL bSuccess = FALSE;
  while (!bSuccess)
  ...
  return m_sExtensionMap.GetCount();
}

CString CIniHttpISAPIManager::GetISAPIExtension(const CHttpRequest& request)
{
